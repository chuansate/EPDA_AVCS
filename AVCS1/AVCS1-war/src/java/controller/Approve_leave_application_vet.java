 ...
 * @author lowsi
 */
@WebServlet(name = "Approve_leave_application_vet", urlPatterns = {"/Approve_leave_application_vet"})
public class Approve_leave_application_vet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        for (LeaveApplication la: leaveApplications) {
            ...
            if (request.getParameter(Long.toString(la.getId())) != null) {
                ...
                laIDToBeEdited = la.getId();
                System.out.println("laIDToBeEdited = " + laIDToBeEdited);
                break;
            }
        }
        
        LeaveApplication laFound = leaveApplicationFacade.find(laIDToBeEdited);
        try (PrintWriter out = response.getWriter()) {
            if (laFound != null) {
                ...
                try {
                    ...
                    out.println("The leave application has been approved!");
                    ...
                    out.println("Failed to approve the leave application due to database issues!");
